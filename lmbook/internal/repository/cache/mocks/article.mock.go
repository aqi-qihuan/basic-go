...
func (mr *MockArticleCacheMockRecorder) DelFirstPage(ctx, uid interface{}) *gomock.Call {
...
func (mr *MockArticleCacheMockRecorder) GetFirstPage(ctx, uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockArticleCacheMockRecorder) SetFirstPage(ctx, uid, res interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockArticleCacheMockRecorder) SetPub(ctx, res interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
