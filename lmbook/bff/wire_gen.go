...
func InitApp() *wego.App {
	...
	collectionHandler := web.NewCollectionHandler(interactiveServiceClient)
	server := ioc.InitGinServer(loggerV1, handler, userHandler, articleHandler, rewardHandler, collectionHandler)
	app := &wego.App{
		WebServer: server,
	}
	return app
