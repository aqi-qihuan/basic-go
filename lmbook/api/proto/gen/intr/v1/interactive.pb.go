...
const file_intr_v1_interactive_proto_rawDesc = "" +
	"\n" +
	"\x19intr/v1/interactive.proto\x12\x0elmbook.intr.v1\"5\n" +
	...
	"\x05intrs\x18\x01 \x03(\v2+.lmbook.intr.v1.GetByIdsResponse.IntrsEntryR\x05intrs\x1aU\n" +
	"\n" +
	"IntrsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x03R\x03key\x121\n" +
	"\x05value\x18\x02 \x01(\v2\x1b.lmbook.intr.v1.InteractiveR\x05value:\x028\x01\">\n" +
	"\vGetResponse\x12/\n" +
	"\x04intr\x18\x01 \x01(\v2\x1b.lmbook.intr.v1.InteractiveR\x04intr\"\xc1\x01\n" +
	...
	"\vIncrReadCnt\x12\".lmbook.intr.v1.IncrReadCntRequest\x1a#.lmbook.intr.v1.IncrReadCntResponse\x12A\n" +
	"\x04Like\x12\x1b.lmbook.intr.v1.LikeRequest\x1a\x1c.lmbook.intr.v1.LikeResponse\x12S\n" +
	"\n" +
	"CancelLike\x12!.lmbook.intr.v1.CancelLikeRequest\x1a\".lmbook.intr.v1.CancelLikeResponse\x12J\n" +
	"\aCollect\x12\x1e.lmbook.intr.v1.CollectRequest\x1a\x1f.lmbook.intr.v1.CollectResponse\x12>\n" +
	"\x03Get\x12\x1a.lmbook.intr.v1.GetRequest\x1a\x1b.lmbook.intr.v1.GetResponse\x12M\n" +
	"\bGetByIds\x12\x1f.lmbook.intr.v1.GetByIdsRequest\x1a .lmbook.intr.v1.GetByIdsResponseB\xae\x01\n" +
	"\x12com.lmbook.intr.v1B\x10InteractiveProtoP\x01Z,basic-go/lmbook/api/proto/gen/intr/v1;intrv1\xa2\x02\x03LIX\xaa\x02\x0eLmbook.Intr.V1\xca\x02\x0eLmbook\\Intr\\V1\xe2\x02\x1aLmbook\\Intr\\V1\\GPBMetadata\xea\x02\x10Lmbook::Intr::V1b\x06proto3"
...
var file_intr_v1_interactive_proto_goTypes = []any{
	(*GetByIdsRequest)(nil),     // 0: lmbook.intr.v1.GetByIdsRequest
	(*GetByIdsResponse)(nil),    // 1: lmbook.intr.v1.GetByIdsResponse
	(*GetResponse)(nil),         // 2: lmbook.intr.v1.GetResponse
	(*Interactive)(nil),         // 3: lmbook.intr.v1.Interactive
	(*GetRequest)(nil),          // 4: lmbook.intr.v1.GetRequest
	(*CollectResponse)(nil),     // 5: lmbook.intr.v1.CollectResponse
	(*CollectRequest)(nil),      // 6: lmbook.intr.v1.CollectRequest
	(*CancelLikeRequest)(nil),   // 7: lmbook.intr.v1.CancelLikeRequest
	(*CancelLikeResponse)(nil),  // 8: lmbook.intr.v1.CancelLikeResponse
	(*LikeRequest)(nil),         // 9: lmbook.intr.v1.LikeRequest
	(*LikeResponse)(nil),        // 10: lmbook.intr.v1.LikeResponse
	(*IncrReadCntRequest)(nil),  // 11: lmbook.intr.v1.IncrReadCntRequest
	(*IncrReadCntResponse)(nil), // 12: lmbook.intr.v1.IncrReadCntResponse
	nil,                         // 13: lmbook.intr.v1.GetByIdsResponse.IntrsEntry
}
var file_intr_v1_interactive_proto_depIdxs = []int32{
	13, // 0: lmbook.intr.v1.GetByIdsResponse.intrs:type_name -> lmbook.intr.v1.GetByIdsResponse.IntrsEntry
	3,  // 1: lmbook.intr.v1.GetResponse.intr:type_name -> lmbook.intr.v1.Interactive
	3,  // 2: lmbook.intr.v1.GetByIdsResponse.IntrsEntry.value:type_name -> lmbook.intr.v1.Interactive
	11, // 3: lmbook.intr.v1.InteractiveService.IncrReadCnt:input_type -> lmbook.intr.v1.IncrReadCntRequest
	9,  // 4: lmbook.intr.v1.InteractiveService.Like:input_type -> lmbook.intr.v1.LikeRequest
	7,  // 5: lmbook.intr.v1.InteractiveService.CancelLike:input_type -> lmbook.intr.v1.CancelLikeRequest
	6,  // 6: lmbook.intr.v1.InteractiveService.Collect:input_type -> lmbook.intr.v1.CollectRequest
	4,  // 7: lmbook.intr.v1.InteractiveService.Get:input_type -> lmbook.intr.v1.GetRequest
	0,  // 8: lmbook.intr.v1.InteractiveService.GetByIds:input_type -> lmbook.intr.v1.GetByIdsRequest
	12, // 9: lmbook.intr.v1.InteractiveService.IncrReadCnt:output_type -> lmbook.intr.v1.IncrReadCntResponse
	10, // 10: lmbook.intr.v1.InteractiveService.Like:output_type -> lmbook.intr.v1.LikeResponse
	8,  // 11: lmbook.intr.v1.InteractiveService.CancelLike:output_type -> lmbook.intr.v1.CancelLikeResponse
	5,  // 12: lmbook.intr.v1.InteractiveService.Collect:output_type -> lmbook.intr.v1.CollectResponse
	2,  // 13: lmbook.intr.v1.InteractiveService.Get:output_type -> lmbook.intr.v1.GetResponse
	1,  // 14: lmbook.intr.v1.InteractiveService.GetByIds:output_type -> lmbook.intr.v1.GetByIdsResponse
